...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyByIdAndGetPageWithVacancyOne() {
        var expectedVacancies = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        when(vacancyService.findById(1)).thenReturn(Optional.of(expectedVacancies));
    ...
    @Test
    public void whenRequestVacancyByIdAndGetErrorPageWithMessage() {
    ...
    @Test
    public void whenPostVacancyUpdateAndRedirectToVacanciesPage() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenPostVacancyUpdateAndGetErrorMessage() throws IOException {
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
    ...
    @Test
    public void whenRequestVacancyDeleteByIdAndRedirectToVacanciesPage() {
    ...
    @Test
    public void whenRequestVacancyDeleteByIdAndGetErrorMessage() {
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
